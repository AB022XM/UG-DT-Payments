...
class UserServiceIT {
    ...
    /**
     * This repository is mocked in the ug.co.absa.payment.repository.search test package.
     *
     * @see ug.co.absa.payment.repository.search.UserSearchRepositoryMockConfiguration
     */
    @SpyBean
